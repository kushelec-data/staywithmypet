/**
 * Dump services sheet from EST and ENG texts.xlsx
 * Run: node scripts/dump-services-sheet.mjs
 */
...
const idx = sheetNames.indexOf("services") + 1;
if (idx === 0) {
  console.error("services sheet not found. Sheets:", sheetNames.join(", "));
  process.exit(1);
}
