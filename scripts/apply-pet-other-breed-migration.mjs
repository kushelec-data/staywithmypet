/**
 * Applies pets.other_breed migration.
...
async function main() {
  ...
  const sqlPath = path.join(
    __dirname,
    "..",
    "supabase/migrations/20260720150000_pet_other_breed.sql",
  );
  ...
  for (const dbUrl of dbUrls) {
    ...
    try {
      ...
      console.log("Applied: supabase/migrations/20260720150000_pet_other_breed.sql");
      return;
    } catch (err) {
      lastError = err;
