...
const zipPath = path.join(root, ".test-co.zip");
const extractDir = path.join(root, ".test-co");
...
const t = getCell(rows, 145, 2);
console.log(JSON.stringify(t));
console.log("regex", /Stay With My Pet\s*[\u2013\u2014-]\s*Lareflexion/i.test(t));
console.log("lare", /Lareflexion\s*OÜ/i.test(t));
