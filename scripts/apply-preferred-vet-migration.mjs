/**
 * Applies supabase/migrations/20260720120000_preferred_vet_clinic.sql
...
async function main() {
  ...
  const sqlPath = path.join(
    ...
    "supabase",
    "migrations",
    "20260720120000_preferred_vet_clinic.sql",
  );
  ...
  for (const dbUrl of dbUrls) {
    ...
    try {
      ...
      console.log("Applied preferred vet clinic migration successfully.");
      return;
    } catch (err) {
      lastError = err;
