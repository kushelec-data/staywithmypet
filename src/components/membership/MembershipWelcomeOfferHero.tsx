    ...
    >
      ...
      <div className="relative flex w-full flex-col gap-4 lg:flex-row lg:items-center lg:gap-16 xl:gap-20">
        <div className="min-w-0 lg:w-[62%]">
          ...
          <h2 className="mt-4 max-w-xl font-heading text-[1.625rem] font-bold leading-[1.12] tracking-[-0.02em] text-[#2B2B2B] sm:text-[2rem] lg:text-[2.625rem]">
            <span className="block">{copy.headlineLine1}</span>
            <span className="block">{copy.headlineLine2}</span>
          </h2>

          <p className="mt-2.5 text-sm leading-snug text-[#4B5563]">{copy.supporting}</p>
          <p className="mt-2 text-xs text-[#9CA3AF]">{copy.footnote}</p>
        </div>
