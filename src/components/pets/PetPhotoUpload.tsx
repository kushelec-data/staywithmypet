...
export function PetPhotoUpload({
  ...
  function handleFilesSelected(selected: FileList | null) {
    ...
    if (unsupported.length > 0) {
      setPickError("Files must be images (JPEG, PNG, WebP) or videos (MP4, WebM).");
    }
  ...
  const busy = disabled || cropSaving || replacingExisting;
  ...
  return (
    <>
      ...
      <PhotoCropModal
        ...
        saving={cropSaving || replacingExisting}
        onClose={() => {
          if (cropSaving || replacingExisting) return;
