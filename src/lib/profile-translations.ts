...
const PROFILE_LABEL_PAIRS: Pair[] = [
  ...
  ["Please specify the breed", "Palun täpsustage tõug"],
  ["Write the breed", "Kirjuta tõug"],
  ["Enter the breed or mix", "Sisesta tõug või segu"],
  ["Breed is required.", "Tõug on kohustuslik."],
  ...
  ["Puppies / kittens", "Kutsikad / kassipojad"],
  ["Comfortable with behavioral quirks?", "Sobivad ka käitumuslike eripäradega lemmikud?"],
  ["Willing to care for special medical needs?", "Valmis hoolitsema erivajadustega lemmikute eest?"],
  ["Happy to care for senior pets?", "Valmis hoolitsema eakate lemmikute eest?"],
  ["Happy with puppies & kittens?", "Valmis hoolitsema kutsikate ja kassipoegade eest?"],
  ...
  ["Comfortable with dogs and cats", "Koerad ja kassid sobivad"],
  ...
  ["Pet types", "Milliste lemmikloomade eest oled valmis hoolitsema?"],
  ...
  ["When and how long you can help.", "Millal ja kui kaua saad aidata."],
  ["Preferred days & times", "Eelistatud päevad ja ajad"],
  ["Duration of care preferred", "Eelistatud hoiuperioodi pikkus"],
  ["Pets at home (optional detail)", "Kodus olevad lemmikud (valikuline)"],
  ["Additional availability notes", "Kas on veel midagi, mida oma saadavuse kohta lisada?"],
  ["What pets and care you're comfortable offering.", "Milliste lemmikute eest ja millist hooldust oled valmis pakkuma."],
  ["Add when you're available to help.", "Lisa, millal saad aidata."],
  ["Add what care you're comfortable offering.", "Lisa, millist hooldust oled valmis pakkuma."],
  ["Do you have other pets at home?", "Kas sul on kodus teisi lemmikloomi?"],
  ["What type of home do you live in?", "Millises elukeskkonnas sa elad?"],
...
const PROFILE_OPTION_PAIRS: Pair[] = [
  ...
  ["Mornings", "Hommikud"],
  ["Afternoons", "Pärastlõunad"],
  ["Evenings", "Õhtud"],
  ["Flexible", "Paindlik"],
  ["A few hours", "Mõni tund"],
  ["One day", "Üks päev"],
