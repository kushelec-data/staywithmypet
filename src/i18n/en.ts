export const en = {
  ...
  account: {
    ...
    createPetFriendProfile: "Create Pet Friend profile",
    createPetParentProfile: "Create Pet Parent profile",
    completeSetupBeforeSwitchingRoles: "Complete setup before switching roles",
  ...
  dashboardHome: {
    ...
    profileVisibility: {
      hidden: "Hidden",
      public: "Public",
      stepsRemainingOne: "Only 1 more step until your profile is public.",
      stepsRemainingMany: "Only {count} more steps until your profile is public.",
      encouragement: "Complete your profile to appear in search results.",
      ...
      congratsBody: "Your profile is now visible to pet owners searching in your area.",
      congratsBodyShort: "Your profile is now public.",
    },
  },
  profileCompleteness: {
  ...
  profileRequiredFields: {
    ...
    missingOne: "1 required item remaining:",
    missingMany: "{count} required items remaining:",
  ...
  profileEdit: {
    ...
    wizard: {
      ...
      statusOneRequiredMissing: "1 required item missing",
      statusNRequiredMissing: "{count} required items missing",
      statusOptionalRemaining: "Optional details remaining",
      previous: "Previous",
      nextStep: "Next",
  ...
  trustSafety: {
    ...
    phonePrivacyHelper: "Private on your public profile. Shared with your care match after a booking is accepted.",
    ...
    emergencyPrivacyHelper: "Private on your public profile. Shared with your care match after a booking is accepted when needed.",
  ...
  matches: {
    pageTitle: "Matches",
    pageDescription: "Weekly recommendations based on location, availability, and care fit.",
    loading: "Loading matches…",
    loadError: "Could not load matches.",
    emptyTitle: "No matches yet",
    emptyDescription: "When we find a good fit, it will appear here once a week.",
    forPet: "Recommended Pet Friends for {name}",
    petsYouMayEnjoy: "Pets you may enjoy caring for",
    matchLabel: "match",
    goodFit: "Good fit because:",
    viewProfile: "View profile",
    viewPet: "View pet",
    notInterested: "Not interested",
    yourPet: "your pet",
    petFriend: "Pet Friend",
    petFallback: "Pet",
  ...
  notifications: {
    ...
    actionViewMatches: "View matches",
