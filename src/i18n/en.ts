export const en = {
  ...
  account: {
    ...
    profileSetup: {
      ...
      aboutMeDescription: "Name, location, languages, and a short bio.",
      ...
      locationCityHint: "Pick a suggested city or type your area.",
      myAvailabilityHint:
  ...
  dashboardHome: {
    ...
    locationPetCare: "Location & pet care",
    ...
    addLocationForClinics: "Add location to see nearby clinics.",
    setLocationForClinics: "Set your location to see nearby vet clinics.",
    editProfile: "Edit profile",
    publicProfile: "Public profile",
    goPublic: "Go public",
    copyPublicLink: "Copy public profile link",
    ...
    addLocationInProfile: "Add location in profile",
  ...
  profileRequiredFields: {
    ...
    errors: {
      ...
      location: "Please add your city or location.",
