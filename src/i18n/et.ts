export const et = {
  ...
  searchFilters: {
    ...
    searchFriendPlaceholder: "Otsi sõpra, märksõna…",
    showFilters: "Näita filtreid",
    hideFilters: "Peida filtrid",
    clearAll: "Tühjenda kõik",
    availableFrom: "Saadaval alates",
    availableUntil: "Saadaval kuni",
    availability: "Saadavus",
    chooseDates: "Vali kuupäevad",
    anyDates: "Kõik kuupäevad",
    clearDates: "Tühjenda",
    done: "Valmis",
    availabilityPickerHint: "Puuduta päevi. Vahemiku valimiseks hoia Shift ja klõpsa teist päeva.",
    showMore: "Näita veel {count}",
    showLess: "Näita vähem",
    activeFilters: "Aktiivsed filtrid",
    removeFilter: "Eemalda filter",
    careLocationFriendHint: "Hooldus sõbra kodus",
    careLocationParentHint: "Hooldus sinu kodus",
    careLocationFlexibleHint: "Mõlemad asukohad sobivad",
    location: "Asukoht",
    locationPlaceholder: "Linn või postiindeks",
    petType: "Loomaliik",
    breed: "Tõug",
    breedHint: "Vali üks või mitu tõugu",
    size: "Kaalukategooria",
    energyLevel: "Energiatase",
    temperament: "Temperament",
    medicalNeeds: "Meditsiiniline vajadus",
    activityNeeds: "Aktiivsus",
    careLocation: "Hoolduse asukoht",
    careLocationAny: "Kõik asukohad",
    careType: "Hoolduse tüüp",
    verification: "Kinnitamine",
    verifiedOnly: "Ainult kinnitatud profiilid",
    languages: "Keeled / suhtlus",
    petTypesAccepted: "Lemmikloomad, keda hooldan",
    careTypeOffered: "Pakutav hoolduse tüüp",
    experience: "Kogemus",
    homeSuitability: "Kodu sobivus",
