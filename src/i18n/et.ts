export const et = {
  ...
  reviews: {
    ...
    tagsLabel: "Sildid (valikuline)",
    textLabel: "Lühike märkus (valikuline)",
    textPlaceholder: "Mis läks hästi?",
  ...
  howItWorksPage: {
    ...
    explainer: {
      ...
      petParent: {
        ...
        scenes: [
          {
            title: "Lisa oma lemmik",
            caption: "Jaga rutiine, vajadusi ja iseloomu.",
            imageAlt: "Lemmiku profiili lisamine",
          },
          {
            title: "Leia usaldusväärseid sõpru",
            caption: "Sirvi kinnitatud profiile enda lähedal.",
            imageAlt: "Lemmikusõprade profiilikaardid",
          },
          {
            title: "Saada või taotle hoolduse kuupäevi",
            caption: "Vali kuupäevad ja lepi hooldus kokku.",
            imageAlt: "Kalender ja hoolduse taotlus",
            modalTitle: "Taotle hoolduse kuupäevi",
            modalCta: "Saada taotlus",
          },
          {
            title: "Vestle turvaliselt",
            caption: "Suhtle rakenduses enne kinnitamist.",
      ...
      petFriend: {
        ...
        scenes: [
          {
            title: "Loo lemmikusõbra profiil",
            caption: "Jaga kogemust, elustiili ja saadavust.",
            imageAlt: "Lemmikusõbra profiili loomine",
          },
          {
            title: "Sirvi lemmikuid lähedal",
            caption: "Avasta Paula, Loore, Denny ja teised.",
            imageAlt: "Lähedal olevate lemmikute kaardid",
          },
          {
            title: "Saada hoolduse taotlus",
            caption: "Vali kuupäevad ja paku jalutuskäike või külastusi.",
            imageAlt: "Hoolduse taotluse saatmine",
            modalTitle: "Saada hoolduse taotlus",
            modalCta: "Saada taotlus",
          },
          {
            title: "Vestle omanikuga",
            caption: "Lepi detailid kokku enne hooldust.",
            imageAlt: "Vestlus lemmiklooma omanikuga",
            messages: [
              { from: "them", text: "Kas saaksid Paulaga laupäeval aidata?" },
              { from: "me", text: "Muidugi — mulle meeldiks temaga tutvuda!" },
              { from: "them", text: "Suurepärane — ta armastab pargi jalutuskäike." },
            ],
          },
          {
            title: "Veeta aega lemmikuga",
            caption: "Jalutuskäigud, külastused ja uuendused hoolduse ajal.",
            imageAlt: "Aja veetmine lemmikuga õues",
            spendLabel: "Hoolitsusaeg Paulaga",
          },
          {
            title: "Ehita arvustusi ja usaldust",
            caption: "Teeni tärne pärast iga lõpetatud broneeringut.",
