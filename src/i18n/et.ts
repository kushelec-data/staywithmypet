export const et = {
  ...
  dashboardHome: {
    ...
    profileVisibility: {
      hidden: "Peidetud",
      public: "Avalik",
      stepsRemainingOne: "Veel 1 samm ja sinu profiil on avalik.",
      stepsRemainingMany: "Veel {count} sammu ja sinu profiil on avalik.",
      encouragement: "Täida oma profiil, et ilmuda otsingutulemustes.",
      percentComplete: "{percent}% valmis",
      missingHeading: "Puudu:",
      moreMissing: "+{count} veel",
      completeProfile: "Täida profiil",
      viewPublicProfile: "Vaata avalikku profiili",
      congratsTitle: "Palju õnne!",
      congratsBody: "Sinu profiil on nüüd nähtav sinu piirkonda otsivatele loomaomanikele.",
      congratsBodyShort: "Sinu profiil on nüüd avalik.",
    },
  },
  profileCompleteness: {
  ...
  profileRequiredFields: {
    ...
    missingOne: "1 kohustuslik väli on veel täitmata:",
    missingMany: "{count} kohustuslikku välja on veel täitmata:",
    completeNow: "Täida kohe",
    items: {
      display_name: "Kuvatav nimi",
      profile_photo: "Profiilifoto",
      location: "Aadress",
  ...
  profileEdit: {
    ...
    wizard: {
      ...
      statusOneRequiredMissing: "1 kohustuslik väli puudub",
      statusNRequiredMissing: "{count} kohustuslikku välja puudub",
      statusOptionalRemaining: "Valikulised detailid puuduvad",
      previous: "Eelmine",
      nextStep: "Järgmine",
  ...
  trustSafety: {
    ...
    phoneNationalHint: "Lisa mobiilinumber ilma riigikoodita. Numbri muutmine tühistab kinnituse, kuni uus kinnitamine on saadaval.",
    phonePrivacyHelper: "Privaatne avalikus profiilis. Jagatakse hoolduspartneriga pärast broneeringu kinnitamist.",
    ...
    emergencyPrivacyHelper: "Privaatne avalikus profiilis. Jagatakse hoolduspartneriga pärast broneeringu kinnitamist vajadusel.",
  ...
  matches: {
    pageTitle: "Sobivused",
    pageDescription: "Iganädalased soovitused asukoha, saadavuse ja hoolduse põhjal.",
    loading: "Laadin sobivusi…",
    loadError: "Sobivusi ei õnnestunud laadida.",
    emptyTitle: "Sobivusi pole veel",
    emptyDescription: "Kui leiame hea paari, ilmub see siia kord nädalas.",
    forPet: "Soovitatud loomasõbrad lemmikule {name}",
    petsYouMayEnjoy: "Lemmikud, kelle eest võiksid hoolitseda",
    matchLabel: "sobivus",
    goodFit: "Hea sobivus, sest:",
    viewProfile: "Vaata profiili",
    viewPet: "Vaata lemmikut",
    notInterested: "Ei ole huvitatud",
    yourPet: "sinu lemmik",
    petFriend: "Loomasõber",
    petFallback: "Lemmik",
  ...
  notifications: {
    ...
    actionViewMatches: "Vaata sobivusi",
    groupMatches: "Sobivused",
  },
  messages: {
    pageTitle: "Sõnumid",
